...
class Summarizer:
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system", 
                        "content": PromptTemplates.get_system_role("content_strategist")
                    },
            ...
            # 确保包含原文链接
            if not "阅读原文" in summary and not item.link in summary:
                summary += f"\n\n� 阅读原文：{item.link}"
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": f"{PromptTemplates.ARTICLE_CLASSIFICATION}\n\nContent:\n{content}"}
                ],
                max_tokens=50,
                temperature=0.1
            )
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": f"{PromptTemplates.ARTICLE_TAGS}\n\nContent:\n{content}"}
                ],
                max_tokens=100,
                temperature=0.3
            )
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": f"{PromptTemplates.ARTICLE_SCORING}\n\nContent:\n{content}"}
                ],
                max_tokens=20,
                temperature=0.1
            )
    ...
    def _simple_score_article(self, item: RSSItem) -> int:
        ...
        try:
            ...
            # 关键词加分
            quality_keywords = ['获奖', '突破', '创新', '发布', '宣布', '合作', '投资', '融资', '上市', '收购']
