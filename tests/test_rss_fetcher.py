...
from src.rss_fetcher import RSSFetcher, RSSItem, RSSCache
...
class TestRSSFetcher:
    ...
    @patch('src.rss_fetcher.requests.get')
    ...
    def test_fetch_latest_items_success(self, mock_parse: Mock, mock_get: Mock) -> None:
        ...
        mock_feed.feed = {"title": "测试RSS源"}
        
        mock_parse.return_value = mock_feed
        
        with patch('src.rss_fetcher.RSSCache') as mock_cache_class:
            mock_cache = Mock()
    ...
    def test_fetch_latest_items_http_error(self, mock_get: Mock) -> None:
        ...
        with patch('src.rss_fetcher.RSSCache'):
            fetcher = RSSFetcher()
